        ...
        {BLOCK_TYPES.map(({ type, label, icon }) => (
          <button
            ...
            style={{
              ...
              background: '#f0f4ff', color: '#3b5af5', border: '1px dashed #3b5af5',
          ...
          <div key={index} style={{ background: '#fafafa', borderRadius: 10, padding: '0.75rem 1rem', border: '1px solid #e5e7eb' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.5rem' }}>
              <span style={{
                ...
                background: block.type === 'heading' ? '#fef3c7' : block.type === 'link' ? '#dbeafe' : block.type === 'divider' ? '#f3f4f6' : '#dcfce7',
                color: block.type === 'heading' ? '#92400e' : block.type === 'link' ? '#1d4ed8' : block.type === 'divider' ? '#6b7280' : '#166534',
            ...
            {block.type === 'link' && (
              <div style={{ display: 'flex', gap: '0.5rem', flexDirection: 'column' }}>
                <input
                  ...
                  placeholder="Button label (e.g. Apply Here)"
                  style={{ fontSize: 13 }}
                />
                <input
                  className="form-input"
