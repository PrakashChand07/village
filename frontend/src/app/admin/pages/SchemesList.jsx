    ...
    <div>
      ...
      <div className="table-container">
        {loading ? (
          ...
          <table>
            <thead><tr>
              <th>Title</th><th>Category</th><th>Benefit</th><th>Status</th><th>Actions</th>
            </tr></thead>
            <tbody>
              {items.map((item) => (
                <tr key={item._id}>
              ...
              {items.length === 0 && (
                <tr><td colSpan={5} style={{ textAlign: 'center', color: 'var(--gray)', padding: '3rem' }}>No schemes found. Add your first!</td></tr>
              )}
            </tbody>
          </table>
        )}
        ...
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, padding: '1rem' }}>
          <div style={{ background: '#fff', borderRadius: 20, padding: '2rem', width: '100%', maxWidth: 560, maxHeight: '90vh', overflowY: 'auto' }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit" className="btn-primary" style={{ marginTop: '0.5rem' }} disabled={saving}>
