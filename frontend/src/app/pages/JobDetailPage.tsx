  ...
  return (
    <div className="min-h-screen py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        {/* Header Card */}
        <div className="bg-gradient-to-br from-orange-500 to-amber-600 text-white rounded-3xl p-8 mb-8 shadow-xl shadow-orange-100">
          <div className="flex items-start gap-4 mb-6">
            ...
            <div className="flex-1">
              ...
              <h1 className="text-2xl sm:text-3xl font-bold leading-tight">{job.title}</h1>
