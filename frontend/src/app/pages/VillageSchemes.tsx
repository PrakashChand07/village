  ...
  return (
    <div className="min-h-screen py-8">
      <div className="max-w-7xl mx-auto px-4">
        {/* Header */}
        <div className="bg-gradient-to-r from-[#2D7A1F] to-[#6DBE45] text-white rounded-3xl md:p-8 p-4 mb-4 md:mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-white/90 mt-2 text-sm md:text-xl">Government welfare schemes for villages</p>
            </div>
          </div>
        </div>
