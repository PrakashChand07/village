    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-gray-500 text-lg font-medium">Loading scholarship details...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <h3 className="text-xl font-bold text-gray-700">Scholarship Not Found</h3>
          <p className="text-gray-500">This scholarship may have been removed.</p>
          <button
            onClick={() => navigate("/scholarship")}
            className="bg-purple-600 text-white px-6 py-2.5 rounded-xl font-bold hover:bg-purple-700 transition-all flex items-center gap-2"
          >
  ...
  return (
    <div className="min-h-screen py-8">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <button
          onClick={() => navigate("/scholarship")}
          className="flex items-center gap-2 text-purple-600 font-semibold hover:text-purple-800 transition-colors mb-6 group"
        >
            ...
            <div className="flex-1">
              <div className="flex flex-wrap items-center gap-2 mb-3">
                <span className="bg-white/20 text-white text-xs font-bold px-3 py-1 rounded-full flex items-center gap-1">
                  <Tag className="w-3 h-3" /> {scholarship.category}
                </span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-2 sm:gap-4  mb-4 sm:mb-8 ">
          ...
          {/* Apply Button card */}
          {scholarship.applyLink && scholarship.applyLink !== '#' && (
            <a
              href={formatUrl(scholarship.applyLink)}
              target="_blank"
              rel="noopener noreferrer"
              className="bg-purple-600 hover:bg-purple-700 transition-all text-white rounded-2xl p-4 flex items-center justify-center gap-2 font-bold text-sm shadow-lg shadow-purple-100"
            >
        ...
        {/* Rich Content Blocks */}
        {scholarship.blocks && scholarship.blocks.length > 0 && (
                ...
                if (block.type === "link") {
                  return (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-3 bg-purple-50 hover:bg-purple-100 border border-purple-200 rounded-2xl px-5 py-4 transition-all group w-fit"
                    >
        ...
        {scholarship.applyLink && scholarship.applyLink !== '#' && (
          <div className="flex justify-center mb-8">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 bg-gradient-to-r from-purple-600 to-violet-600 text-white px-8 py-3.5 rounded-2xl font-bold text-base hover:from-purple-700 hover:to-violet-700 transition-all shadow-lg shadow-purple-200"
            >
              <BadgeCheck className="w-5 h-5" /> Apply for This Scholarship
            </a>
          </div>
        )}
